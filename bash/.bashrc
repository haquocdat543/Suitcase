...
alias k8smc='. ~/preconfig/Suitcase/bash/master-ubuntu.sh'
alias k8swu='. ~/preconfig/Suitcase/bash/master-ubuntu.sh'
alias k8swc='. ~/preconfig/Suitcase/bash/master-ubuntu.sh'
...
alias ycwa='sudo yum install amazon-cloudwatch-agent -y'
alias ydk='yd ; ed ; sd'
