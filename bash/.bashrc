...
alias upss='plug ; yg ; yn ; gceh ; gcnh ; cm ; sn ; ed400 ; up2 ; rv ; up3 ; rtm ; invim ; ipip ; ipynvim ; plug2 ; up5 ; rnv '
...
alias eag='. ~/preconfig/commands/eag.sh'
alias ag='ag --hidden'
alias val='vi ~/.bashrc'
...
alias swl='.  ~/preconfig/commands/switch.sh'
...
alias up6='bash <(curl -s https://raw.githubusercontent.com/haquocdat543/Suitcase/main/bash/luaconfig.sh)'
...
alias iag='. ~/preconfig/commands/agInstall.sh'
alias invim='. ~/preconfig/commands/nvimInstall.sh'
...
alias ylib='yum -y groupinstall "Development Tools"'
