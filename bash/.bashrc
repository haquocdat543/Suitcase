...
alias ijenkin='. ~/preconfig/Suitcase/bash/commands/jenkinInstall.sh'
...
alias a2ceall='a2ceg1 | grep Amount ; a2ceg2 | grep Amount ; a2ceg3 | grep Amount ; a2ceg4 | grep Amount ; a2ceg5 | grep Amount ; a2ceg6 | grep Amount ; a2ceg7 | grep Amount ; a2ceg8 | grep Amount ; a2ceg9 | grep Amount ; a2ceg10 | grep Amount ; a2ceg11 | grep Amount ; a2ceg12 | grep Amount '
alias a2call='echo "1" ; a2ceg1 | grep Amount ; echo "2" ; a2ceg2 | grep Amount ; echo "3" ; a2ceg3 | grep Amount ; echo "4" ; a2ceg4 | grep Amount ; echo "5" ; a2ceg5 | grep Amount ; echo "6" ; a2ceg6 | grep Amount ; echo "7" ; a2ceg7 | grep Amount ; echo "8" ; a2ceg8 | grep Amount ; echo "9" ; a2ceg9 | grep Amount ; echo "10" ; a2ceg10 | grep Amount ; echo "11" ; a2ceg11 | grep Amount ; echo "12" ; a2ceg12 | grep Amount '
alias a2ceg1='aws ce get-cost-and-usage     --time-period Start=2023-01-01,End=2023-02-01     --granularity MONTHLY --metrics "NetAmortizedCost"'
alias a2ceg2='aws ce get-cost-and-usage     --time-period Start=2023-02-01,End=2023-03-01     --granularity MONTHLY --metrics "NetAmortizedCost"'
alias a2ceg3='aws ce get-cost-and-usage     --time-period Start=2023-03-01,End=2023-04-01     --granularity MONTHLY --metrics "NetAmortizedCost"'
alias a2ceg4='aws ce get-cost-and-usage     --time-period Start=2023-04-01,End=2023-05-01     --granularity MONTHLY --metrics "NetAmortizedCost"'
alias a2ceg5='aws ce get-cost-and-usage     --time-period Start=2023-05-01,End=2023-06-01     --granularity MONTHLY --metrics "NetAmortizedCost"'
alias a2ceg6='aws ce get-cost-and-usage     --time-period Start=2023-06-01,End=2023-07-01     --granularity MONTHLY --metrics "NetAmortizedCost"'
alias a2ceg7='aws ce get-cost-and-usage     --time-period Start=2023-07-01,End=2023-08-01     --granularity MONTHLY --metrics "NetAmortizedCost"'
alias a2ceg8='aws ce get-cost-and-usage     --time-period Start=2023-08-01,End=2023-09-01     --granularity MONTHLY --metrics "NetAmortizedCost"'
alias a2ceg9='aws ce get-cost-and-usage     --time-period Start=2023-09-01,End=2023-10-01     --granularity MONTHLY --metrics "NetAmortizedCost"'
alias a2ceg10='aws ce get-cost-and-usage     --time-period Start=2023-10-01,End=2023-11-01     --granularity MONTHLY --metrics "NetAmortizedCost"'
alias a2ceg11='aws ce get-cost-and-usage     --time-period Start=2023-11-01,End=2023-12-01     --granularity MONTHLY --metrics "NetAmortizedCost"'
alias a2ceg12='aws ce get-cost-and-usage     --time-period Start=2023-12-01,End=2024-01-01     --granularity MONTHLY --metrics "NetAmortizedCost"'
