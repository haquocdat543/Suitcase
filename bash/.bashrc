...
alias itrivy='. ~/preconfig/Suitcase/bash/commands/trivyInstall.sh'
...
alias hdc='hexdump -C'
alias fz='filepath=$(fzf) ; vi $filepath'
alias fzz='cd $(find . -type d -print | fzf)'
