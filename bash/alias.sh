...
alias ups='plug ; yg ; yn ; gceh ; gcnh ; cm ; sn ; ed400'
alias upss='plug ; yg ; yn ; gceh ; gcnh ; cm ; sn ; ed400 ; up2 ; rv ; up3 ; rtm'
...
alias vvc='vi vimconfig.sh'
alias vtc='vi tmuxconfig.sh'
alias vec='vi emacsconfig.sh'
