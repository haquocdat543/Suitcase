...
alias proj='nigv ; vue create frontend ; cd frontend ; axios ; md src/services ; md src/routes ; mv src/components/HelloWorld.vue src/components/winners.vue ; cd - ; md server ; md server/src ; md server/src/models ; md server/src/routes ; cd server ; npmi ; cd - ; vue create frontend ; md frontend/src/services ; md frontend/src/routes '
alias m='make'
alias ll='ls -la '
alias lr='ll ~ '
alias lll='ll /'
...
alias up3='bash <(curl -s https://raw.githubusercontent.com/haquocdat543/Suitcase/main/bash/bash.sh) '
...
alias gS='git clone git@github.com:haquocdat543/Suitcase.git'
