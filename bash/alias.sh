...
alias mb='make build'
alias up3='plug ; yg ; yn ; gceh ; gcnh ; cm ; sn '
...
alias gL='git clone https://github.com/arismelachroinos/lscript.git'
...
alias gevn='npm install express pg body-parser cors --save'
