...
alias proj='md server ; md server/src ; md server/src/models md server/src/routes ; cd server ; npmi ; cd - ; vue create frontend ; md frontend/src/services ; md frontend/src/routes '
alias m='make'
alias ll='ls -la '
alias lr='ll ~ '
alias lll='ll /'
