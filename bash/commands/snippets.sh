...
rm -f ~/preconfig/snippets/md.snippets && touch ~/preconfig/snippets/md.snippets && curl -s https://raw.githubusercontent.com/haquocdat543/Suitcase/main/snippets/md.snippets | sudo tee -a ~/preconfig/snippets/md.snippets
