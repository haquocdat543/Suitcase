...
rm -f ~/preconfig/snippets/gitcommit.snippets && touch ~/preconfig/snippets/gitcommit.snippets && curl -s https://raw.githubusercontent.com/haquocdat543/Suitcase/main/snippets/gitcommit.snippets | sudo tee -a ~/preconfig/snippets/gitcommit.snippets
