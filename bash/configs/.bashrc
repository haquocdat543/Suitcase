...
### Git command [change directory base on git data]
...
alias ksd='. $HOME/preconfig/Suitcase/bash/scripts/kubernetesScaleDeployment.sh'
alias kssts='. $HOME/preconfig/Suitcase/bash/scripts/kubernetesScaleStatufulSet.sh'
