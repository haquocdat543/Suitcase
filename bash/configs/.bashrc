...
alias dritrmap='docker run -it --rm --net host alpine'
alias dritrmct='docker run -it --rm --net host centos'
alias dritrmub='docker run -it --rm --net host ubuntu'
alias dritrmal='docker run -it --rm --net host archlinux'
