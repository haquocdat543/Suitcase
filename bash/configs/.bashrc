...
alias ag='ag --hidden'
alias virclc='n /etc/rc.local'
alias vifc='n *.FCMacro'
alias viz='n ~/.zshrc'
alias val='n ~/.bashrc'
alias vgdb='n ~/.gdbinit'
alias vlk='n ~/Suitcase/bash/link.txt'
alias vac='n ~/Suitcase/windows/alias.cmd'
alias vws='n ~/Suitcase/windows/setup.bat'
alias vicp='n ./docker-compose.yaml'
alias vigr2='n /etc/grub2.cfg'
alias vij2='n ./*.j2'
alias vigig='n ./.gitignore'
alias vihig='n ./.helmignore'
alias vihr='n ./redis-values.yaml'
alias vidig='n ./.dockerignore'
alias vikub='n ~/.kube/config'
alias vigcf='n ./.gitconfig'
alias vicf='n ./configure'
alias vicfac='n ./configure.ac'
alias vim4='n ./aclocal.m4'
alias vimkt='n ./Makefile.tpl'
alias vimka='n ./Makefile.am'
alias vimki='n ./Makefile.in'
alias vidk='n ./Dockerfile'
alias vivg='n ./Vagrantfile'
alias vijk='n ./Jenkinsfile'
alias vitv='n ./.travis.yml'
alias vicc='n .circleci/config.yml'
alias vigf='n ./Gemfile'
alias vigfl='n ./Gemfile.lock'
alias vipf='n ./Pipfile'
alias vipfl='n ./Pipfile.lock'
alias vimk='n ./Makefile'
alias vibs='n ./buildspec.yml'
alias vias='n ./appspec.yml'
alias vbbk='n ~/preconfig/backup/.bashrc.backup'
alias vvbk='n ~/preconfig/backup/.vimrc.backup'
alias vtbk='n ~/preconfig/backup/.tmux.conf.backup'
alias vrc='n ~/.vimrc'
alias vtm='n ~/.tmux.conf'
alias vbcf='n ~/bat.conf'
alias viy='n *.yaml'
alias vish='n *.sh'
alias viwf='n ./.github/workflows/*'
alias viwfb='n ./.github/workflows/build.yml'
alias vigl='n .gitlab-ci.yml'
alias viinv='n inventory'
alias vee='n ~/init.el'
alias va='n ~/Suitcase/bash/configs/.bashrc'
alias vipj='n package.json'
alias vdel='n delete.sh'
alias vdel2='n delete2.sh'
alias vdel3='n delete3.sh'
alias vvc='n ~/Suitcase/bash/configs/.vimrc'
alias vnc='n ~/Suitcase/bash/configs/init.vim'
alias vtc='n ~/Suitcase/bash/configs/.tmux.conf'
alias swl='.  ~/preconfig/Suitcase/bash/scripts/switch.sh'
alias cad='.  ~/preconfig/Suitcase/bash/scripts/switchCad.sh'
alias vlc='n ~/Suitcase/bash/configs/init.lua'
alias vec='n init.el'
alias vrcu='n ~/preconfig/.vimrc'
alias vrco='n ~/preconfig/previmrc'
alias vtmu='n ~/preconfig/.tmux.conf'
alias vtmo='n ~/preconfig/pretmux'
alias veeu='n ~/preconfig/init.el'
alias veeo='n ~/preconfig/preinitel'
alias viid='n ~/.ssh/id_ed25519'
alias visshcf='n ~/.ssh/config'
alias virsapu='n ~/.ssh/id_rsa.pu'
alias virsapr='n ~/.ssh/id_rsa'
alias vrsa='n ~/.ssh/id_rsa'
alias viah='n /etc/ansible/hosts'
alias viacf='n /etc/ansible/ansible.cfg'
alias vi8='n *'
alias visu='n /etc/sudoers'
alias vitab='n /etc/fstab'
alias vilim='n /etc/security/limits.conf'
alias visys='n /etc/sysctl.conf'
alias asudo='. ~/preconfig/Suitcase/bash/scripts/addSudoers.sh'
alias vissh='n /etc/ssh/sshd_config'
alias ssha='eval $(ssh-agent) && ssh-add'
alias sshad='eval $(ssh-agent) && ssh-add ~/.ssh/id_ed25519'
alias sshac='eval $(ssh-agent) && ssh-add ~/.ssh/id_rsa'
alias vmc='n ./main.c'
alias vimt='n main.tf'
alias vimx='n main.tex'
alias viva='n variables.tf'
...
alias up2='. ~/preconfig/Suitcase/bash/scripts/alias2.sh'
...
### Documentation
alias dock8s='n -m ~/preconfig/Suitcase/bash/docs/dock8s.md'
alias doccr='n -m ~/preconfig/Suitcase/bash/docs/crypto.md'
alias docgcc='n -m ~/preconfig/Suitcase/bash/docs/gcc.md'
alias dochelm='n -m ~/preconfig/Suitcase/bash/docs/dochelm.md'
alias docsql='n -m ~/preconfig/Suitcase/bash/docs/docsql.md'
alias docfzf='n -m ~/preconfig/Suitcase/bash/docs/fzf.md'
alias docbash='n -m ~/preconfig/Suitcase/bash/docs/bash.md'
alias docans='n -m ~/preconfig/Suitcase/bash/docs/ansible.md'
...
alias vikz='n ./kustomization.yaml'
...
alias vicgt='n Cargo.toml'
alias vicgl='n Cargo.lock'
alias virs='n *.rs'
