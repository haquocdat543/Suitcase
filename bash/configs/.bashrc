...
alias upu='. ~/preconfig/Suitcase/bash/scripts/copySuitcase.sh'
alias upS='. ~/preconfig/Suitcase/bash/scripts/alias2.sh'
...
alias loop='. ~/preconfig/Suitcase/bash/scripts/loopShell.sh'
alias llg='. ~/preconfig/Suitcase/bash/scripts/llg.sh'
alias llgc='. ~/preconfig/Suitcase/bash/scripts/llgc.sh'
alias lp='netstat -lnp'
alias fk='fuser -k'
alias lbk='ll ~/preconfig/backup'
alias cdl='cd /'
alias cdsc='cd ~/Suitcase/bash/scripts'
alias cdcex='cd $HOME/Library/Application\ Support/Google/Chrome/Default/Extensions'
alias cddt='cd ~/Suitcase/bash/data'
alias cdif='cd ~/Suitcase/bash/infra'
alias cdcf='cd ~/Suitcase/bash/configs'
...
alias viz='vim ~/.zshrc'
alias val='vim ~/.bashrc'
alias vgdb='vim ~/.gdbinit'
alias vlk='vim ~/Suitcase/bash/link.txt'
alias vac='vim ~/Suitcase/windows/alias.cmd'
alias vws='vim ~/Suitcase/windows/setup.bat'
...
alias vbbk='vim ~/preconfig/backup/.bashrc.backup'
alias vvbk='vim ~/preconfig/backup/.vimrc.backup'
alias vtbk='vim ~/preconfig/backup/.tmux.conf.backup'
alias vrc='vim ~/.vimrc'
alias vtm='vim ~/.tmux.conf'
alias vbcf='vim ~/bat.conf'
alias viy='vim *.yaml'
alias vish='vim *.sh'
...
alias vee='vim ~/init.el'
alias va='vim ~/Suitcase/bash/configs/.bashrc'
alias vipj='vim package.json'
alias vdel='vim delete.sh'
alias vdel2='vim delete2.sh'
alias vdel3='vim delete3.sh'
alias vvc='vim ~/Suitcase/bash/configs/.vimrc'
alias vnc='vim ~/Suitcase/bash/configs/init.vim'
alias vtc='vim ~/Suitcase/bash/configs/.tmux.conf'
alias swl='.  ~/preconfig/Suitcase/bash/scripts/switch.sh'
alias cad='.  ~/preconfig/Suitcase/bash/scripts/switchCad.sh'
alias vlc='vim ~/Suitcase/bash/configs/init.lua'
alias vec='vim init.el'
alias vrcu='vim ~/preconfig/.vimrc'
alias vrco='vim ~/preconfig/previmrc'
alias vtmu='vim ~/preconfig/.tmux.conf'
alias vtmo='vim ~/preconfig/pretmux'
alias veeu='vim ~/preconfig/init.el'
alias veeo='vim ~/preconfig/preinitel'
alias viid='vim ~/.ssh/id_ed25519'
alias visshcf='vim ~/.ssh/config'
alias virsapu='vim ~/.ssh/id_rsa.pu'
alias virsapr='vim ~/.ssh/id_rsa'
alias vrsa='vim ~/.ssh/id_rsa'
...
alias sshah='eval $(ssh-agent) && ssh-add ~/.ssh/id_ed25519'
alias sshac='eval $(ssh-agent) && ssh-add ~/.ssh/id_rsa'
alias sshan='eval $(ssh-agent) && ssh-add ~/.ssh/notional'
...
alias diffbin='. ~/preconfig/Suitcase/bash/scripts/diffBinary.sh'
alias vdbin='. ~/preconfig/Suitcase/bash/scripts/binVimdiff.sh'
alias sshci='. ~/preconfig/Suitcase/bash/scripts/sshCopyId.sh'
alias sshcia='. ~/preconfig/Suitcase/bash/scripts/sshCopyIdAuthentication.sh'
alias cpbk='. ~/preconfig/Suitcase/bash/scripts/copyBatchOfPublicKey.sh'
...
alias sn='. ~/preconfig/scripts/snippets.sh'
alias rr='. ~/.bashrc'
alias rdh='readelf -h'
alias rdl='readelf -l'
...
alias up2='. ~/preconfig/Suitcase/bash/scripts/vimconfig.sh'
alias up3='. ~/preconfig/Suitcase/bash/scripts/tmuxconfig.sh'
alias up4='. ~/preconfig/Suitcase/bash/scripts/emacsconfig.sh'
alias up5='. ~/preconfig/Suitcase/bash/scripts/nvimconfig.sh'
alias up6='. ~/preconfig/Suitcase/bash/scripts/luaconfig.sh'
...
alias k8smu='. ~/preconfig/Suitcase/bash/scripts/master-ubuntu.sh'
alias k8smc='. ~/preconfig/Suitcase/bash/scripts/master-centos.sh'
...
### Documentation
alias dock8s='vim -m ~/preconfig/Suitcase/bash/docs/dock8s.md'
alias doccr='vim -m ~/preconfig/Suitcase/bash/docs/crypto.md'
alias docgcc='vim -m ~/preconfig/Suitcase/bash/docs/gcc.md'
alias dochelm='vim -m ~/preconfig/Suitcase/bash/docs/dochelm.md'
alias docsql='vim -m ~/preconfig/Suitcase/bash/docs/docsql.md'
alias docfzf='vim -m ~/preconfig/Suitcase/bash/docs/fzf.md'
...
alias doctr='vim -m ~/preconfig/Suitcase/bash/docs/tr.md'

### Installation
alias igo='. ~/preconfig/Suitcase/bash/scripts/goInstall.sh'
alias ifzf='. ~/preconfig/Suitcase/bash/scripts/fzfInstall.sh'
alias ieksctl='. ~/preconfig/Suitcase/bash/scripts/eksctlInstall.sh'
alias ikubectl='. ~/preconfig/Suitcase/bash/scripts/kubectlInstall.sh'
alias ilg='. ~/preconfig/Suitcase/bash/scripts/lazygit.sh'
alias ilk='. ~/preconfig/Suitcase/bash/scripts/lazykubernetes.sh'
alias ild='. ~/preconfig/Suitcase/bash/scripts/lazydocker.sh'
alias ik9s='. ~/preconfig/Suitcase/bash/scripts/k9s.sh'
alias iag='. ~/preconfig/Suitcase/bash/scripts/agInstall.sh'
alias invim='. ~/preconfig/Suitcase/bash/scripts/nvimInstall.sh'
...
alias ikubectl='. ~/preconfig/Suitcase/bash/scripts/kubectl.sh'
alias ikub='. ~/preconfig/Suitcase/bash/scripts/kubectl.sh'
alias irg='. ~/preconfig/Suitcase/bash/scripts/ripgrep.sh'
...
alias igg='. ~/preconfig/Suitcase/bash/scripts/gcpCli.sh'
alias icabal='. ~/preconfig/Suitcase/bash/scripts/cabalInstall.sh'
alias ikustomize='. ~/preconfig/Suitcase/bash/scripts/kustomizeInstall.sh'
alias ikus='. ~/preconfig/Suitcase/bash/scripts/kustomizeInstall.sh'
...
alias igaiad='. ~/preconfig/Suitcase/bash/scripts/gaiaInstall.sh'
alias icccli='. ~/preconfig/Suitcase/bash/scripts/circleCliInstall.sh'
alias iredisfs='. ~/preconfig/Suitcase/bash/scripts/redisInstallFromSource.sh'
alias ikom='. ~/preconfig/Suitcase/bash/scripts/komposeInstall.sh'
alias ipulumi='. ~/preconfig/Suitcase/bash/scripts/pulumiInstall.sh'
alias igrype='. ~/preconfig/Suitcase/bash/scripts/grypeInstall.sh'
alias idelta='. ~/preconfig/Suitcase/bash/scripts/deltaInstall.sh'
alias iignite='. ~/preconfig/Suitcase/bash/scripts/igniteInstallation.sh'
...
alias ikind='. ~/preconfig/Suitcase/bash/scripts/kindInstall.sh'
alias ikrew='. ~/preconfig/Suitcase/bash/scripts/krewInstall.sh'
alias ihermes='. ~/preconfig/Suitcase/bash/scripts/hermesInstall.sh'
...
alias iglab='. ~/preconfig/Suitcase/bash/scripts/gitlabCliInstall.sh'
alias ipacker='. ~/preconfig/Suitcase/bash/scripts/packerInstall.sh'
alias ivault='. ~/preconfig/Suitcase/bash/scripts/vaultInstall.sh'
alias iconsul='. ~/preconfig/Suitcase/bash/scripts/consulInstall.sh'
alias ietcd='. ~/preconfig/Suitcase/bash/scripts/etcdInstall.sh'
alias ipsql='. ~/preconfig/Suitcase/bash/scripts/postgresInstall.sh'
alias itrivy='rpm -ivh https://github.com/aquasecurity/trivy/releases/download/v0.18.3/trivy_0.18.3_Linux-64bit.rpm'
alias gettrivy='. ~/preconfig/Suitcase/bash/scripts/trivyGet.sh'
alias unistio='. ~/preconfig/Suitcase/bash/scripts/istioInstall.sh'
alias iistio='. ~/preconfig/Suitcase/bash/scripts/istioInstall.sh'
alias iargocd='. ~/preconfig/Suitcase/bash/scripts/argoCDInstall.sh'
alias iteleinflux='. ~/preconfig/Suitcase/bash/scripts/teleInfluxInstall.sh'
alias igrafana='. ~/preconfig/Suitcase/bash/scripts/grafanaInstall.sh'
alias igra='. ~/preconfig/Suitcase/bash/scripts/grafanaInstall.sh'
alias isonarqube='. ~/preconfig/Suitcase/bash/scripts/sonarqubeInstall.sh'
alias isonar='. ~/preconfig/Suitcase/bash/scripts/sonarqubeInstall.sh'
alias yzsh='yum install -y zsh'
alias iohmyzsh='sudo curl -L http://install.ohmyz.sh | sh'
alias izellij='. ~/preconfig/Suitcase/bash/scripts/zellijInstall.sh'
alias ihelm='. ~/preconfig/Suitcase/bash/scripts/helmInstall.sh'
...
alias idk='yd ; sd ; ed'
alias rmssd='. ~/preconfig/Suitcase/bash/scripts/removeSystemd.sh'
...
alias flcsgs='. ~/preconfig/Suitcase/bash/scripts/fluxCreateSourceGit.sh'
alias flchr='flux create helmRelease'
alias flck='flux create kustomization'
alias flcks='. ~/preconfig/Suitcase/bash/scripts/fluxCreateKustomization.sh'
...
alias a2clmd='. ~/preconfig/Suitcase/bash/scripts/clmDeploy.sh'
alias a2clmu='. ~/preconfig/Suitcase/bash/scripts/clmUpdate.sh'
alias a2clmdcap='. ~/preconfig/Suitcase/bash/scripts/clmDeployCapability.sh'
...
alias a2rdsci='. ~/preconfig/Suitcase/bash/scripts/rds.sh'
...
alias a2eccc='. ~/preconfig/Suitcase/bash/scripts/elasticache.sh'
...
alias a2lmdi='. ~/preconfig/Suitcase/bash/scripts/lambdaInvoke.sh'
...
alias a2iamulk='. ~/preconfig/Suitcase/bash/scripts/iamUploadKey.sh'
alias a2iamdk='. ~/preconfig/Suitcase/bash/scripts/iamDeleteKey.sh'
...
alias gggkcf='. ~/preconfig/Suitcase/bash/scripts/gcloudGetKubeconfig.sh'
...
alias azrbac='. ~/preconfig/Suitcase/bash/scripts/azureRBAC.sh'
...
alias azaksgcc='. ~/preconfig/Suitcase/bash/scripts/azureGetCredentials.sh'
...
alias gclc='. ~/preconfig/Suitcase/bash/scripts/githubSshCloneCad.sh'
alias gcls='. ~/preconfig/Suitcase/bash/scripts/githubSshClone.sh'
alias gclh='. ~/preconfig/Suitcase/bash/scripts/githubHttpClone.sh'
...
alias gL='git clone https://github.com/rancher/quickstart ~/quickstart'
...
alias gcfa='. ~/preconfig/Suitcase/bash/scripts/gitAddAlias.sh'
...
alias gckn='. ~/preconfig/Suitcase/bash/scripts/gckNumber.sh'
alias gcknm='. ~/preconfig/Suitcase/bash/scripts/gckNumberMerge.sh'
...
alias scpkube='. ~/preconfig/Suitcase/bash/scripts/scpkube.sh'
alias scpssh='. ~/preconfig/Suitcase/bash/scripts/scpssh.sh'
alias cpb='. ~/preconfig/Suitcase/bash/scripts/copyToBinDir.sh'
alias cproot='. ~/preconfig/Suitcase/bash/scripts/copyroot.sh'
alias gall='. ~/preconfig/Suitcase/bash/gitconfig/gitPushOriginMain.sh'
alias cmd='. ~/preconfig/Suitcase/bash/scripts/cmd.sh'
alias doc='. ~/preconfig/Suitcase/bash/scripts/doc.sh'
alias cnt='. ~/preconfig/Suitcase/bash/scripts/connect.sh'
alias nven='. ~/preconfig/Suitcase/bash/scripts/nvimen.sh'
alias ven='. ~/preconfig/Suitcase/bash/scripts/vimen.sh'
alias gr='git remote'
alias gpl='git pull'
...
alias anpp='. ~/preconfig/Suitcase/bash/scripts/ansiblePlaybookInventory.sh'
...
alias angrs='. ~/preconfig/Suitcase/bash/scripts/galaxyRoleSearch.sh'
alias angri='. ~/preconfig/Suitcase/bash/scripts/roleInfo.sh'
...
alias dvch='. ~/preconfig/Suitcase/bash/scripts/dockerHostMount.sh'
alias dritm='. ~/preconfig/Suitcase/bash/scripts/dockerMount.sh'
alias dvf='. ~/preconfig/Suitcase/bash/scripts/dockerVolumeFrom.sh'
...
alias dbplf='. ~/preconfig/Suitcase/bash/scripts/dockerBuildPlatform.sh'
alias dt='docker tag'
alias dlg='docker login'
...
### Kubectl command
alias oidc='. ~/preconfig/Suitcase/bash/scripts/oidc.sh'
alias expkub='. ~/preconfig/Suitcase/bash/scripts/exportKubeConfig.sh'
alias k='kubectl'
...
alias kcsi='. ~/preconfig/Suitcase/bash/scripts/imagePullSecret.sh'
...
alias kmcp='. ~/preconfig/Suitcase/bash/scripts/controlplaneCertificate.sh'
...
alias kpsci='. ~/preconfig/Suitcase/bash/scripts/clusterIP.sh'
alias kpslb='. ~/preconfig/Suitcase/bash/scripts/loadBalancer.sh'
alias kpsnp='. ~/preconfig/Suitcase/bash/scripts/nodePort.sh'
...
alias kubex='. ~/preconfig/Suitcase/bash/scripts/kubeExport.sh'
alias kcv='kubectl config view'
alias kcvf='kubectl config view --flatten'
alias kcvfk='kubectl config view --flatten > ~/.kube/config'
...
alias hmiv='. ~/preconfig/Suitcase/bash/scripts/helmInstallValues.sh'
alias hmtpt='. ~/preconfig/Suitcase/bash/scripts/helmTemplateTest.sh'
...
alias cpl='. ~/preconfig/Suitcase/bash/scripts/cpl.sh'
...
alias gog='go get'
alias goa='. ~/preconfig/Suitcase/bash/scripts/goa.sh'
...
alias rdcn='. ~/preconfig/Suitcase/bash/scripts/redisConnect.sh'
alias rdcnp='. ~/preconfig/Suitcase/bash/scripts/redisConnectPassword.sh'
...
alias cmk..='cmake ../'
alias cmkd='cmake -D'
alias mkgcc='. ~/preconfig/Suitcase/bash/scripts/makeGcc.sh'
...
### Other command
alias sqlcn='. ~/preconfig/Suitcase/bash/scripts/sqlConnect.sh'
alias cntn='. ~/preconfig/Suitcase/bash/scripts/countFileNumber.sh'
alias cntl='. ~/preconfig/Suitcase/bash/scripts/countFileLocation.sh'
alias cntb='. ~/preconfig/Suitcase/bash/scripts/countFileNL.sh'
alias dkau='. ~/preconfig/Suitcase/bash/scripts/addUserDocker.sh'
alias rpl='. ~/preconfig/Suitcase/bash/scripts/rpl.sh'
...
alias dot='. ~/preconfig/Suitcase/bash/scripts/dot.sh'
alias addas='. ~/preconfig/Suitcase/bash/scripts/addAutoSuggest.sh'
alias addzsh='. ~/preconfig/Suitcase/bash/scripts/addZshSource.sh'
