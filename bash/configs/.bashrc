...
alias cdsscf='cd $HOME/secret-suitcase/config'
alias cdsssc='cd $HOME/secret-suitcase/script'
alias cdssdoc='cd $HOME/secret-suitcase/doc'
...
alias ssha0='eval $(ssh-agent) && ssh-add $HOME/.ssh/Window2.pem'
...
alias gclsrssp='. $HOME/preconfig/Suitcase/bash/scripts/secretRepositoryPreconfig.sh 1 github.com haquocdat543 secret-suitcase'
alias gclsrssh='. $HOME/preconfig/Suitcase/bash/scripts/secretRepositoryPreconfig.sh 2 github.com haquocdat543 secret-suitcase'
...
alias kgmesha='. $HOME/preconfig/Suitcase/bash/scripts/kubeGetMeshAll.sh'
