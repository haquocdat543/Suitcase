...
### Documentation
alias dock8s='vim -m $HOME/preconfig/Suitcase/bash/docs/dock8s.md'
alias doccr='vim -m $HOME/preconfig/Suitcase/bash/docs/crypto.md'
alias docgcc='vim -m $HOME/preconfig/Suitcase/bash/docs/gcc.md'
alias dochelm='vim -m $HOME/preconfig/Suitcase/bash/docs/dochelm.md'
alias docsql='vim -m $HOME/preconfig/Suitcase/bash/docs/docsql.md'
