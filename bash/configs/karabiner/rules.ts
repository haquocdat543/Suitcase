...
const rules: KarabinerRules[] = [
  ...
  // I tried using spacebar as the hyper key but cannot type well
  {
    ...
    manipulators: [
      {
        description: "Open DBeaver with caps lock + D",
        from: {
          key_code: "d",
          modifiers: {
      ...
      {
        description: "Open VSCode with caps lock + V",
        from: {
          key_code: "v",
          modifiers: {
            // All of these are right_command
      ...
      {
        description: "Open Telegram with caps lock + T",
        from: {
          key_code: "t",
          modifiers: {
            // All of these are right_command
      ...
      {
        description: "Open Slack with caps lock + S",
        from: {
          key_code: "s",
          modifiers: {
            // All of these are right_command
      ...
      {
        description: "Open Zalo with caps lock + Z",
        from: {
          key_code: "z",
          modifiers: {
            // All of these are right_command
        ...
        to: [
          {
            shell_command: "open -a 'Zalo'",
          },
        ],
        type: "basic",
      },
      {
        description: "Open Postman with caps lock + P",
        from: {
          key_code: "p",
          modifiers: {
            // All of these are right_command
      ...
      {
        description: "Open Chrome with caps lock + C",
        from: {
          key_code: "c",
          modifiers: {
            // All of these are right_command
      ...
      {
        description: "Open Blender with caps lock + B",
        from: {
          key_code: "b",
          modifiers: {
            // All of these are right_command
        ...
        to: [
          {
            shell_command: "open -a 'Blender'",
          },
        ],
        type: "basic",
      },
      {
        description: "Open Discord with left option + D",
        from: {
          key_code: "d",
          modifiers: {
            // All of these are right_command
      ...
      {
        description: "Open Iterm2 with caps lock + I",
        from: {
          key_code: "i",
          modifiers: {
            // All of these are right_command
