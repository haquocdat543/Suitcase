...
IF not exist %USERPROFILE%/preconfig ( md %USERPROFILE%/preconfig )
IF not exist %USERPROFILE%/.vim ( md %USERPROFILE%/.vim )
IF not exist %USERPROFILE%/.vim/autoload ( md %USERPROFILE%/.vim/autoload )
%USERPROFILE%/.reg
